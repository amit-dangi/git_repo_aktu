...
<script type="text/javascript" src="../resources/js/affiliation/inspection-by-governbody.js"></script>
...
<div class="container-fluid">
  <div id="" class="page-header"><h4>Inspection by Government Body for Registrar Granted Applications</h4></div>
			...
			<div class="col-md-12 table-responsive" style="padding: 0px;display: inline-block;">
				...
				<div class="col-md-12 table-responsive" style="padding: 0px;display: inline-block;">
					...
					<table id="" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%" ">
						<thead>
							<tr>
								<th style="text-align:center; width:10%;">Registrar (Affiliation Approved by)</th>
								<!-- <th style="text-align:center; width:10%;">Submitted Application (By Member)</th> -->
								<th style="text-align:center; width:8%;">Feedback (By Registrar )</th>
								<th style="text-align:center; width:8%;">Remarks (By Registrar)</th>
							<tr>
						</thead>	
						<tbody id="Dtable">
						</tbody>
			 ...
			 <div class="col-sm-12">
			  ...
			  <div class="col-md-12 text-center m-t-20" id="showbtn" style="padding: 0px; display:none;">
			  		<button type="button" class="btn btn-view btnSave" id="btnSave" onClick="Save('Y')">Application Accepted & transferred to Registrar</button>
