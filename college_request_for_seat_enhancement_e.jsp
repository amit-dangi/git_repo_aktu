...
<script type="text/javascript" src="../resources/js/affiliation/college-request-for-seat-enhancement.js"></script>
...
<div class="container-fluid">
  <div id="" class="page-header"><h4>Consolidate Inspection by Committee</h4></div>
	...
	<div class="panel-body">
			...
			<div class="col-md-12 table-responsive" style="padding: 0px;display: inline-block;">
					...
					<table id="" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%" ">
						<thead>
							<tr>
								...
								<th style="text-align:center; width:10%;">Panel Member</th>
								<th style="text-align:center; width:10%;">Submitted Application (By Member)</th>
								<th style="text-align:center; width:8%;">Remarks (By Member)</th>
								<th style="text-align:center; width:8%;">Recommendation (By Member)</th>
							<tr>
						</thead>	
						<tbody id="Dtable">
						</tbody>
				...
				<div class="form-group">
					<div class="col-md-12">
						<div class="row">
							<label class="col-sm-2 col-form-label text-right required-field"  for="">Remarks</label>
							  <div class="col-sm-10">
								<textarea class="" id="remarks" value="" style="height: 80px;width: 100%;resize:vertical;max-height:120px;"></textarea>
						     </div>
					   </div>
				   </div>
				</div>
					...
					<div class="col-md-12">
						<div class="row">
							<label class="col-sm-2 col-form-label text-right required-field" for="">Recommendation</label>
							  <div class="col-sm-10">
								<textarea class="" id="Recommendation" value="" style="height: 80px;width: 100%; resize:vertical;max-height:120px;"></textarea>
						     </div>
					   </div>
				   </div>
				</div>
			 ...
			 <div class="col-sm-12">
			  ...
			  <div class="col-md-12 text-center m-t-20" id="showbtn" style="padding: 0px; display:none;">
			  		<button type="button" class="btn btn-view btnSave" id="btnSave" onClick="Save('N')">Application ReOpen</button>
					<button type="button" class="btn btn-view btnSave" id="btnSave" onClick="Save('Y')">Application Granted</button>
