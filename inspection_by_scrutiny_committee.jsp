...
<div class="container-fluid">
  <div id="" class="page-header"><h4>Inspection by Scrutiny Committee of Final Submitted Applications</h4></div>
 <form class="form-horizontal" name="InspectionSCform" id="InspectionSCform" action="" method="post" autocomplete="off">
  <div class="panel panel-default">
   <div class="panel-heading"><h3 class="panel-title text-right">Search Record</h3></div>
