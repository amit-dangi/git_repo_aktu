...
//System.out.println("ques_name"+ques_name);
String ques_desc = General.checknull(request.getParameter("ques_desc"));
//ques_name = General.checknull(request.getParameter("ques_name"));
System.out.println(fstatus+"|"+ques_name+"|"+ques_desc);
%>
<body <%-- onload="editView('<%=ques_name%>','<%=fstatus%>');" --%>>
<div class="container-fluid">
   <div id="" class="page-header"><h4><%=ReadProps.getkeyValue("ques_sub_param_mast.header","sitsResource") %></h4></div>
     ...
     <div class="panel-heading"><h3 class="panel-title text-right"><%if(fstatus.equals("N")){ %>New Record<%}else{ %>Update Record<%} %></h3></div>
			<div class="panel-body">
				...
				<div class="col-md-12 text-center m-t-20">
					<button type="button" class="btn btn-view" id="btnView" onclick="view('<%=ques_name%>','');">View</button>
					...
					<div class="col-md-12">
						<div class="row">
							<label class="col-sm-2 col-form-label required-field" for="">Feedback Question Description</label>
							  <div class="col-sm-4">
								 <textarea rows="5" class="col-sm-12" id="" placeholder="Enter Feedback Question Description" style="height: 50px;"></textarea>		
						     </div>
				...
				<div class="form-group">
					<div class="col-md-12">
						<div class="row">
							<label class="col-sm-2 col-form-label" for="">feedback Question Description</label>
							 <div class="col-sm-4">
								<select class="form-control" id="ques_desc" name="ques_desc">
									<option value="">Select feedback Question Description</option>									
								</select>
						    </div>
						   <label class="col-sm-2 col-form-label" for="">Option Value</label>
							 <div class="col-sm-4">
								<select class="form-control" id="opt_val" name="opt_val">
			    ...
			    <div class="form-group">
					<div class="col-md-12">
						<div class="row">
							<label class="col-sm-2 col-form-label required-field " for="">Sub Option Value </label>
							<div class="cover  input_fields_wrap">
							  <div class="col-sm-4" style="margin-bottom: 3px;">
								<input type="text" class="form-control" id="sub_opt1" name="sub_opt1" maxlength="225" placeholder="Enter Sub Option Value ">
						     </div>
				...
				<div class="col-md-12 text-center m-t-20">
					<button type="button" class="btn btn-view" id="btnAddRow" onclick='addRow();'>Add Sub Question</button>
					...
					<input type="hidden" name="flag" id="flag" value="N" readOnly>
						...
						<div id="emp_nominee_detail"
							...
							<div id="END1" class="dataEntryDiv">
								<table id="searchTableE" border="1" cellspacing="1" cellpadding="1" width="100%" class="tableGrid">
								<thead>
									<tr>
										<th style="text-align: center; width: 3%;">S.No.</th>
										<th id="qu_name" style="text-align: center; width: 15%;">Questionnaire Name</th>
				...
				<input type="hidden" name="ques_name_hide" id="ques_name_hide" value="<%=ques_name%>"/> 
				...
				<div class="col-md-12 text-center m-t-20">				
					<button type="button" class="btn btn-view" id="btnSaveUpdate" onclick="saveRecord('E');"
					...
					<button type="button" class="btn btn-view" id="btnBack" onclick=''>Back</button>
					 <button type="button" class="btn btn-view" id="" onclick="download();">downlaod</button>
      ...
      <iframe class="embed-responsive-item" src="quistionnaire_sub_parameter_master_l.jsp" name="ifrm" id="ifrm" frameborder="0" scrolling="no" width="100%" onload="resizeIframe(this)" height=""></iframe>
      ...
      $(document).ready(function() {
    	    var t = $('#searchTableE').DataTable( {
	        	...
	        	buttons: [
	            	{	
   	                	extend: 'excelHtml5',
   	                	filename: 'Questionnaire_Sub_Parameter_Master',
