...
.reg-title{padding:30px 0px 10px 0px;}
	.chrome_box_inst{background-color:#d6b69654;
	height : 195px; 
	padding: 5px 10px !important;
	border-radius: 9px !important;
	margin: 10px;
	-moz-box-shadow: inset 0 0 10px #cfaa86;
	-webkit-box-shadow: inset 0 0 10px #cfaa86;
	box-shadow: inset 0 0 10px #cfaa86;}
	.chrome_img{width:3%; float:left}
	.chrome_txt{padding: 11px 0px 0px 4px; float: left;}
	.b-r-9{border-radius:9px}
	.icn-view{
		color:white !important; float: right; padding-right: 10px;
	}
/* #loader{
...
<script type="text/javascript">
	...
	//script for form call in pdf through jasper
		...
		var jaspername='inspector_inspection_report';
	...
	function downloadJasperReport(Inst_Id)
	{
			...
			var url=tibcoserverUrl+"?flowId=viewReportFlow&_flowId=viewReportFlow&ParentFolderUri=%2Freports&reportUnit="+folder_name
						 		+jaspername+"&standAlone=true&validflag="+validstatus+"&output="+downloadtype+"&j_username="+tibcoserverUsername+"&j_password="+tibcoserverPassword
						 		+"&Inst_Id="+Inst_Id+"&Inspection_by="+Inspection_by+"&session_id="+session_id;
...
<div class="container-fluid">
 <div id="" class="page-header"><h4>Inspection Details (By Inspector <%=user_name%> Panel Member)</h4></div>
 <form class="form-horizontal" name="InspectionDetailFrame" id="InspectionDetailFrame" action="" method="post" autocomplete="off">
   ...
   <div class="panel-heading"><h3 class="panel-title text-right">New Record</h3></div>
	<div class="panel-body">
			...
			<div class="form-group" id="headerdiv" style="display: none;">
				...
				<input type="hidden" id="inspection_by" value="<%=employee_id%>"/>
				<input type="hidden" id="user_status" value="<%=user_status%>"/>
				
		</div> <!-- End of panal body -->
	</div> <!-- End of panal default -->
   </form>
   <iframe class="containerframe" onload="resizeIframe(this)" name="InspectionDetailViewFrame" id="InspectionDetailViewFrame" frameborder="0" scrolling="no" width="100%" height=""></iframe>
