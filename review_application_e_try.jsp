...
<script type="text/javascript" src="../resources/js/affiliation/review-application_try.js"></script>
	...
	<div class="panel-body">
					...
					<div class="col-md-12">
						<div class="row">
						 <label class="col-sm-2 col-form-label" for="">Payment From Date</label>
							...
							<label class="col-sm-2 col-form-label required-field" for="">Payment To Date</label>
							 <div class="col-sm-4">
			...
			<div class="form-group" id="searchTableHeader" style="display: none;">
			  ...
			  <div class="col-sm-12">
				...
				<div id="Detailsdivrem" style="display: none;">	 
				 <div class="form-group">
					<div class="col-md-12">
						<div class="row">
