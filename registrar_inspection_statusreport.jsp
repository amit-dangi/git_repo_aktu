...
<script type="text/javascript" src="../resources/js/affiliation/registrar-inspection-statusreport.js"></script>
...
<div class="container-fluid">
  <div id="" class="page-header"><h4>Registrar Inspection Status Detail Report</h4></div>
					...
					<div class="col-md-12">
						<div class="row">
						   ...
						   <label class="col-sm-2 col-form-label " for="">Status</label>
							  ...
							  <option value="Submitted">Final Submitted Application</option>
							  </select>
						      </div>
					     </div>
				   </div>
