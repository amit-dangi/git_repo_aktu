...
<div class="container-fluid">
  <div id="" class="page-header"><h4>Document Master
   ...
   <div class="panel-heading"><h3 class="panel-title text-right">New Record</h3></div>
		<div class="panel-body">
	 		<div class="form-group">
					<div class="col-md-12">
						<div class="row">
							<label class="col-sm-2 col-form-label required-field" for="">Document Name</label>
							 <div class="col-sm-4">
					...
					<div class="col-md-12">
						<div class="row">
						 <label class="col-sm-2 col-form-label" for="">Sub Request Name</label>
							<div class="col-sm-4">
								<select class="form-control" id="" name="">
									<option value="">Select Sub Request Name</option>
								</select>
						     </div>
						...
						<div class="row">
						   <label class="col-sm-2 col-form-label " for="">Is Active</label>
							   <div class="col-sm-4">
								 ...
								 <label class="col-sm-2 col-form-label" for="">Order By</label>
								  <div class="col-sm-4">
									<input type="text" class="form-control" id="" name="" placeholder="Enter Order By">
							     </div>
						      </div>
					     </div>
				  </div>
					...
					<div class="col-md-12">
						<div class="row">
						   <label class="col-sm-2 col-form-label " for="">Remarks</label>
							  <div class="col-sm-4">
								  <textarea class="" id="" value="" style="width: 100%;height: 60px;" placeholder="Enter Remarks"></textarea>
						      </div>
					     </div>
				   </div>
				</div>
...
<iframe class="embed-responsive-item" src="document_master_l.jsp" onload="resizeIframe(this)" id=""  name="" frameborder="0" scrolling="no" width="100%" height=""></iframe>
   </div>
</body>
<script>
